  ...
  extends ApplicationFrame
{
  ...
  CategoryDataset createDataset(double[] chart)
  {
    ...
    dataset.addValue(chart[0], "Angry" ,"Angry");
    dataset.addValue(chart[1], "Disgust" ,"Disgust");
    dataset.addValue(chart[2], "Scared" ,"Scared");
    dataset.addValue(chart[3], "Happy" ,"Happy");
    dataset.addValue(chart[4], "Sad" ,"Sad");
    dataset.addValue(chart[5], "Surprised" ,"Surprised");
    dataset.addValue(chart[6], "Neutral" ,"Neutral");
    return dataset;
  }
